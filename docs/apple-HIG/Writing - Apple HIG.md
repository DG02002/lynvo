...
Supported platforms
&lt;img&gt;iPhone icon&lt;/img&gt; &lt;img&gt;iPad icon&lt;/img&gt; &lt;img&gt;Mac icon&lt;/img&gt; &lt;img&gt;Apple TV icon&lt;/img&gt; &lt;img&gt;Apple Watch icon&lt;/img&gt; &lt;img&gt;Apple Watch Series 8 icon&lt;/img&gt;
...
Compare the tone of these two examples from Apple Watch. In the first, the tone is straightforward and direct, reflecting the seriousness of the situation. In the second, the tone is

https://developer.apple.com/design/human-interface-guidelines/writing &lt;page_number&gt;1/4&lt;/page_number&gt;
...
light and congratulatory.

&lt;img&gt;A watch face with a message that reads "It looks like you've taken a hard fall." Below it, two buttons: "SOS EMERGENCY SOS" and "I'm OK".&lt;/img&gt;
&lt;img&gt;A watch face with a message that reads "Longest Move Streak You set a personal record for your longest daily Move streak: 35 days!"&lt;/img&gt;
...
**Write for everyone.** For your app to be useful for as many people as possible, it needs to speak to as many people as possible. Choose simple, plain language and write with accessibility and localization in mind, avoiding jargon and gendered terminology. For guidance, see [Writing inclusively](https://developer.apple.com/design/human-interface-guidelines/writing/inclusive-writing/) and [VoiceOver](https://developer.apple.com/accessibility/voicecontrol/); for developer guidance, see [Localization](https://developer.apple.com/design/human-interface-guidelines/localization/).
...
messages like “We’re having trouble loading this content.” Something like “Unable to load content” is much clearer.
...
&lt;img&gt;Handwashing Timer setting on Apple Watch&lt;/img&gt;
...
robotic error messages with no helpful information, like “Invalid name.” For guidance, see Text fields.
...
&lt;img&gt;Two women sitting at a table with an Apple logo and "WWDC25" text.&lt;/img&gt;
Make a big impact with small writing changes

&lt;img&gt;A black background with colorful "hello" text.&lt;/img&gt;
...
<td>Clarified guidance on language patterns, and added guidance for possessive pronouns.</td>
</tr>
<tr>
...
https://developer.apple.com/design/human-interface-guidelines/writing &lt;page_number&gt;4/4&lt;/page_number&gt;

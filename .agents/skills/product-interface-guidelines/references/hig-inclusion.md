...
> Image example: person.crop.circle. Description: A solid silhouette of a person from the shoulders up, within a circle.

> Image example: person.3.fill. Description: Solid silhouettes of three people, with the left silhouette in the foreground and the other two in the background, all from the shoulders up.

> Image example: figure.wave. Description: A solid silhouette of a person standing with an arm raised high on the left side of the image.

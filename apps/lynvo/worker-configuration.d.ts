/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 15a5fea6f8a0c11cee7a0bd1b72a63ca)
// Runtime types generated with workerd@1.20260811.1 2026-08-08 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	PLUGIN_CREDENTIAL_ENCRYPTION_KEY: string;
	LYNVO_PLUGIN_SERVER_API_KEY: string;
	AUTH_RATE_LIMITER: DurableObjectNamespace<import("./workers/app").AuthRateLimiter>;
	WORKER_AUTH_SESSION: DurableObjectNamespace<import("./workers/app").WorkerAuthSession>;
	PLUGIN_SERVER_CREDENTIAL_VAULT: DurableObjectNamespace<import("./workers/app").PluginServerCredentialVault>;
	USER_REALTIME_ROOM: DurableObjectNamespace<import("./workers/app").UserRealtimeRoom>;
	LYNVO_PLUGIN_SERVER: Fetcher /* lynvo-plugin-server-local */ | Fetcher /* lynvo-plugin-server */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "UserRealtimeRoom" | "AuthRateLimiter" | "WorkerAuthSession" | "PluginServerCredentialVault";
	}
	interface LocalEnv {
		CF_VERSION_METADATA: WorkerVersionMetadata;
		...
		PLUGIN_SERVER_CREDENTIAL_VAULT: DurableObjectNamespace<import("./workers/app").PluginServerCredentialVault>;
		USER_REALTIME_ROOM: DurableObjectNamespace<import("./workers/app").UserRealtimeRoom>;
		LYNVO_PLUGIN_SERVER: Fetcher /* lynvo-plugin-server-local */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SERVICE_VERSION" | "COMMIT_HASH" | "TURNSTILE_SITE_KEY" | "VITE_CONVEX_URL" | "AUTH_GATEWAY_SECRET" | "AUTH_SESSION_ENCRYPTION_KEY" | "TURNSTILE_SECRET_KEY" | "PLUGIN_CREDENTIAL_ENCRYPTION_KEY" | "LYNVO_PLUGIN_SERVER_API_KEY">> {}
}

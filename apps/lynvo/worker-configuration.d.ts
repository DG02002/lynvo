/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 341e2f1cd251888ce87d170edd71c83b)
...
interface __BaseEnv_Env {
	...
	OFFICIAL_EXTRACTOR_API_KEY: string;
	...
	EXTERNAL_WORKER_CREDENTIAL_VAULT: DurableObjectNamespace<import("./workers/app").ExternalWorkerCredentialVault>;
	USER_REALTIME_ROOM: DurableObjectNamespace<import("./workers/app").UserRealtimeRoom>;
	OFFICIAL_EXTRACTOR: Fetcher /* lynvo-official-extractor-local */ | Fetcher /* lynvo-official-extractor */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "UserRealtimeRoom" | "AuthRateLimiter" | "WorkerAuthSession" | "ExternalWorkerCredentialVault";
	}
	interface LocalEnv {
		CF_VERSION_METADATA: WorkerVersionMetadata;
		...
		EXTERNAL_WORKER_CREDENTIAL_VAULT: DurableObjectNamespace<import("./workers/app").ExternalWorkerCredentialVault>;
		USER_REALTIME_ROOM: DurableObjectNamespace<import("./workers/app").UserRealtimeRoom>;
		OFFICIAL_EXTRACTOR: Fetcher /* lynvo-official-extractor-local */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SERVICE_VERSION" | "COMMIT_HASH" | "TURNSTILE_SITE_KEY" | "VITE_CONVEX_URL" | "AUTH_GATEWAY_SECRET" | "AUTH_SESSION_MASTER_KEY" | "TURNSTILE_SECRET_KEY" | "PLUGIN_CREDENTIAL_MASTER_KEY" | "OFFICIAL_EXTRACTOR_API_KEY">> {}
}

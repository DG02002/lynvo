/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d2e8980ce4aeb918f12113a0ab0a6d54)
// Runtime types generated with workerd@1.20260721.1 2026-06-29 nodejs_compat
interface __BaseEnv_Env {
	AUTH_RATE_LIMITS: KVNamespace;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "UserRealtimeRoom";
	}
	interface LocalEnv {
		AUTH_RATE_LIMITS: KVNamespace;
		CF_VERSION_METADATA: WorkerVersionMetadata;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SERVICE_VERSION" | "COMMIT_HASH" | "TURNSTILE_SITE_KEY" | "VITE_CONVEX_URL" | "AUTH_GATEWAY_SECRET" | "TURNSTILE_SECRET_KEY" | "PLUGIN_CREDENTIAL_MASTER_KEY" | "OFFICIAL_EXTRACTOR_API_KEY">> {}
}

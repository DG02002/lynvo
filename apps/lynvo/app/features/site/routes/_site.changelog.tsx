...
const changelogEntries: ChangelogEntry[] = [
  ...
  },
  {
    ...
    category: "Product",
    description: [
      "The Save page now has two views. List gives you row-by-row browsing. Gallery groups movies and shows by artwork.",
      "Shows are grouped by season, with posters, season artwork, and episode stills when available. In Gallery view, a group with one season opens straight into a full-screen season view.",

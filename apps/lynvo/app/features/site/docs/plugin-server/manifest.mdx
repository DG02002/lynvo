...
The manifest declares a Custom Plugin Server's identity, protocol features, and Plugins. Read the [protocol overview](/developer/protocol-overview), then match each Plugin entry to the [Source implementation](/developer/plugins).

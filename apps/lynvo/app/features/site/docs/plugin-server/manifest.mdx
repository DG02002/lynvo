...
description: Declare your Plugin Server’s identity, supported URLs, and capabilities.
navLabel: Manifest
...
The manifest lets Lynvo validate compatibility and route URLs without sending them to every Plugin Server. Keep `pluginServerId` stable after anyone connects the Plugin Server.

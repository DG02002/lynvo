...
The manifest lets Lynvo validate compatibility and route URLs without sending them to every Worker. Keep `pluginServerId` stable after anyone connects the Plugin Server.

...
A successful Extraction response connects Plugin metadata to the Media Nodes Lynvo displays or opens. Review the [Media Node reference](/developer/media-nodes) and [structured errors](/developer/errors) alongside this response schema.

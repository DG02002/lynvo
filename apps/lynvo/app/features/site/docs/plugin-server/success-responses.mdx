...
A successful Extraction response connects Plugin metadata to the Media Nodes Lynvo displays or opens. Review the [Media Node reference](/docs/plugin-server/media-nodes) and [structured errors](/docs/plugin-server/errors) alongside this response schema.

...
Generate a standalone Cloudflare Worker project to start a Custom Plugin Server. Complete the [development prerequisites](/developer/prerequisites), then replace its example Plugin and follow the [agent-assisted path](/developer/agent-prompt) or the [protocol guide](/developer/protocol-overview).

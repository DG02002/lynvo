...
description: Generate the Worker shell, install its dependencies, and run the starter locally.
...
Run the creator from the directory where you want the project. It creates a standalone Worker and installs the published protocol package.

...
Use this guide after generating the starter project when you want an agent to implement a Source-specific Plugin. First [prepare your environment](/developer/prerequisites) and [generate the project](/developer/create-plugin-server); then use [protocol testing](/developer/testing) before deployment.

...
export const PrivacyPolicyContent = () => (
  <PolicyLayout title="Privacy policy" updatedAt="July 11, 2026">
    ...
    <PolicySection title="1. Who operates Lynvo and how to contact us">
      <p>
        ...
        the official contact method displayed by the Service for privacy
    ...
    <PolicySection title="3. Data stored on your device">
      <p>
        ...
        theme choice. The browser may also store your theme, player defaults,
        and a temporary real-time session identifier. These items keep your
        session working and remember settings on that browser.
      </p>
      <p>
        Lynvo doesn&apos;t use advertising cookies in the current Service. If
        that changes, this policy and any required consent controls will change
    ...
    <PolicySection title="4. How Lynvo uses data">
      ...
      <p>
        ...
        protecting the Service. Lynvo also processes data when needed to comply
        with law.
      </p>
    </PolicySection>
    ...
    <PolicySection title="5. When data goes to another service">
      ...
      <ul className="list-disc pl-6">
        ...
        <li>
          <strong className="text-foreground">
            Source websites and extraction services:
          </strong>
    ...
    <PolicySection title="7. Retention and automatic deletion">
      <p>
        Your saved-link history uses a 90-day retention window by default. You
        can change it to 7, 30, 90, or 180 days in Settings. Lynvo checks daily
        for saved-link records older than your selected window and deletes them.
      </p>
      <ul className="list-disc pl-6">
      ...
      <p>
        ...
        may not receive a warning before automatic deletion. Sign in and use
    ...
    <PolicySection title="9. Your privacy rights">
      ...
      <p>
        ...
        privacy request, use the official contact method displayed by the
        Service. Lynvo may need information that verifies you control the
    ...
    <PolicySection title="11. Children's privacy">
      <p>
        ...
        you&apos;re below the minimum age required to consent to online services
        where you live. Use the official contact method displayed by the Service
        if you believe a child provided personal data in violation of this
        section.
      </p>
    </PolicySection>
    ...
    <PolicySection title="12. Policy changes">
      <p>
        ...
        change. The updated date shows when the current version took effect.
        Lynvo will provide any additional notice required by law.
      </p>
    </PolicySection>
  </PolicyLayout>
)

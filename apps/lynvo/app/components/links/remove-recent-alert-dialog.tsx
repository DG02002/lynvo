...
interface RemoveRecentAlertDialogProps {
...
export const RemoveRecentAlertDialog = ({
  item,
  open,
  onOpenChange,
  onRemove,
}: RemoveRecentAlertDialogProps) => (
    ...
    <AlertDialogContent className="p-10">
      <AlertDialogHeader className="w-full place-items-center gap-4 text-center">
        ...
        <AlertDialogDescription className="w-full text-center text-base text-muted-foreground">
          This will delete the saved item from your list. You can save it again

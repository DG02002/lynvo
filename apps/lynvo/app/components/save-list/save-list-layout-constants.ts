export const GALLERY_GRID_CLASS =
  "stagger-children grid grid-cols-2 gap-x-4 gap-y-6 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6"
...
// back fills the side column, title next, episode toggle, menu pinned to the
// trailing column at every width (it stays flush right when no toggle shows).
...
export const GALLERY_GROUP_CONTENT_CLASS =
...
export const MEDIA_LIST_EPISODE_STILL_CLASS =
  "block w-full shrink-0 md:w-64 lg:w-96"

export const MEDIA_LIST_EPISODE_STILL_SIZES =

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=OfficialExtractorBindings` (hash: 1a4e83521b08898a2cf44917d77e8b35)
// Runtime types generated with workerd@1.20260721.1 2026-07-19
interface __BaseEnv_OfficialExtractorBindings {
	PUBLIC_ASSET_ORIGIN: "http://localhost:5173/official-extractor-assets" | "";
	OFFICIAL_EXTRACTOR_API_KEY: string;
	OFFICIAL_EXTRACTOR_USAGE_LIMITER: DurableObjectNamespace<import("./src/index").OfficialExtractorUsageLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OfficialExtractorUsageLimiter";
	}
	interface LocalEnv {
		PUBLIC_ASSET_ORIGIN: "http://localhost:5173/official-extractor-assets";
		OFFICIAL_EXTRACTOR_API_KEY: string;
	...
	interface Env extends __BaseEnv_OfficialExtractorBindings {}
}
interface OfficialExtractorBindings extends __BaseEnv_OfficialExtractorBindings {}

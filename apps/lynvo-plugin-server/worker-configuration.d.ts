/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=LynvoPluginServerBindings` (hash: 3e70de368c92fddfc82a0b86ea6c9bfc)
// Runtime types generated with workerd@1.20260804.1 2026-08-08 nodejs_compat
interface __BaseEnv_LynvoPluginServerBindings {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: "development" | "production";
	SERVICE_VERSION: "0.1.0";
	COMMIT_HASH: "unknown";
	PUBLIC_ASSET_ORIGIN: "http://localhost:5173/lynvo-plugin-server-assets" | "https://lynvo.dg02002.workers.dev/lynvo-plugin-server-assets";
	PLUGIN_SERVER_AUTH_KEY: string;
	LYNVO_PLUGIN_SERVER_USAGE_LIMITER: DurableObjectNamespace<import("./src/index").LynvoPluginServerUsageLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LynvoPluginServerUsageLimiter";
	}
	interface LocalEnv {
		CF_VERSION_METADATA: WorkerVersionMetadata;
	...
	interface Env extends __BaseEnv_LynvoPluginServerBindings {}
}
interface LynvoPluginServerBindings extends __BaseEnv_LynvoPluginServerBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SERVICE_VERSION" | "COMMIT_HASH" | "PUBLIC_ASSET_ORIGIN" | "PLUGIN_SERVER_AUTH_KEY">> {}
}
